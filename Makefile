...
.PHONY: compiler-status compiler-seed compiler-smoke profiler-smoke profile-aggregation-smoke profile-compare-smoke process-group-smoke test
...
test: compiler-smoke profiler-smoke profile-aggregation-smoke profile-compare-smoke process-group-smoke
